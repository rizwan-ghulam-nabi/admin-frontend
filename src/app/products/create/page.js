...
export default function CreateProductPage() {
  ...
  const { categories, fetchCategories, loading: categoriesLoading } = useCategoryStore(); // ✅ Use category store
...
useEffect(() => {
  ...
  if (categories && categories.length > 0) {
    ...
    console.log('🔍 DEBUG - All keys in first category:', Object.keys(categories[0]));
  }
}, [categories]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      submitData.append('category', form.category); // ✅ Dynamic category

...
//   const canCreateProducts = permissions?.canCreateProducts || false;
//   const canUpdateProducts = permissions?.canUpdateProducts || false;
//   const canDeleteProducts = permissions?.canDeleteProducts || false;
...
//       return mainImage ? (
//         <img src={mainImage} alt={row.name} className="h-12 w-12 rounded object-cover" />
//       ) : (
...
//         {row.comparePrice && (
//           <p className="text-xs text-gray-400 line-through">${row.comparePrice?.toFixed(2)}</p>
//         )}
//       </div>
//     ),
//   },
...
//   // ✅ Use canManageProducts with fallback
